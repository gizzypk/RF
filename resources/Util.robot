...
*** Keywords ***
Open Web Browser
    [Arguments]    ${url}=${URL}    ${browser}=chromeß
    Open Browser    ${url}    ${browser}    alias=saucedemo
    ...    options=binary_location="${EXECDIR}/chrome/Google Chrome for Testing.app/Contents/MacOS/Google Chrome for Testing"     # ;add_experimental_option("detach", True)
